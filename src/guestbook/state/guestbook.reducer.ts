...
export const getGuestbookFeatureState = createFeatureSelector<GuestbookState>('guestbook')
export const getGuestbookRecords = createSelector(getGuestbookFeatureState, state => state.records)

export const createGuestbookRecord = createAction(
  description`Create record`,
  props<GuestbookRecord>()
)

export const guestbookReducer = createReducer<GuestbookState>({
  records: []
}, on(createGuestbookRecord, (state, record) => ({
  ...state,
  records: [
